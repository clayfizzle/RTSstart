 var EF = {
	...
	spawnEnemyUnit: function() {
		...
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('melee', 	[ 0, 1, 2, 3], 10, true);
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('fire', 		[ 4, 5, 6, 7], 10, true);
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('scrounge',  [ 8, 9,10,11], 10, true);
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('wait ',		[12,13,14,15], 10, true);
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('walk', 		[16,17,18,19], 10, true);
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('die', 	 	[20,21,22,23], 10, true);
		this.enemyUnitArray[this.enemyUnitCount].sprite.animations.add('magic', 	[24,25,26,27], 10, true);
