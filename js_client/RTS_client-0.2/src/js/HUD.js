var HUD = {
	...
	createHUD: function() {
    	...
    	coinText = game.add.text(10, 10, "COIN: 0", { font: "24px Arial", fill: "#ff3388", align: "center" });
    	coinText.fixedToCamera = true;
    	
    	enemyText = game.add.text(10, 34, "Enemy: 0", { font: "24px Arial", fill: "#ff3388", align: "center" });
    	enemyText.fixedToCamera = true;
    	
    	unitText = game.add.text(10, 58, "Units: 0", { font: "24px Arial", fill: "#ff3388", align: "center" });
    	unitText.fixedToCamera = true;

    	//Left Hand buttons

	    //aButton = game.add.button(10, SCREEN_H - 74, 'metalButton64', this.actionOnClickA, game, 2, 1, 0);
	    aButton = game.add.button(10, SCREEN_H - 74, 'redButtonImg', this.actionOnClickA, game, 2, 1, 0);
    	...
    	bButton = game.add.button(10 + 64 + 10, SCREEN_H - 74, 'blueButtonImg', this.actionOnClickB, game, 2, 1, 0);
    	...
    	eButton = game.add.button(10 + 128 + 20, SCREEN_H - 74, 'greenButtonImg', this.actionOnClickE, game, 2, 1, 0);
	...
	notOverButtons: function(x, y){
		...
		if(this.overAnyButton(this.x, this.y)){
			//console.log("not overbutons this.x, this.y: " +this.x+ ", "+this.y);
